...
This repository contains the code for the datasets and experiments of our paper: [The Inherent Limits of Pretrained LLMs: The Unexpected Convergence of Instruction Tuning and In-Context Learning Capabilities](https://github.com/UKPLab/arxiv2025-inherent-limits-plms).
