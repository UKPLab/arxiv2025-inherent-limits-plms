...
PATTERNS = {
    ...
    "aeslc": [
        ...
        ("{email_body}\nWrite a subject line for this email.", "{subject_line}"),
        ("Here is an email: {email_body}\nWhat is a potential subject line for this email?", "{subject_line}"),
        ("{email_body}\nPropose a subject line for this email?", "{subject_line}"),
        ("This is the content of an email: {email_body}\nWhat was the subject line for this email?", "{subject_line}"),
        ("This is an email\n{email_body}\n\nWhat is the subject of this email?", "{subject_line}"),
        ("{email_body}\n\nGenerate a subject line for this email.", "{subject_line}"),
        ("Write an email with the following subject:\n\n{subject}", "{email_body}"),
        ("Write an email with the subject line \"{subject_line}\".", "{email_body}"),
    ],
    "cnn_dailymail": [
        ...
        ("{highlights}\n\nWrite an article based on these highlights.", "{article}"),
    ],
    "gigaword": [
        ("Write a short summary for this text: {document}", "{summary}"),
        ("Briefly summarize this sentence: {document}", "{summary}"),
        ...
        ("Write a sentence based on this summary: {summary}", "{document}"),
        ("Write a sentence based on \"{summary}\"", "{document}"),
    ],
    "multi_news": [
    ...
    "openbookqa": [
        ("{fact}\n{question_stem}\n\n{options_}", "{answer}"),
        ("Read this fact: \"{fact}\"\n\nNow answer this question: \"{question_stem}\"\n\n{options_}", "{answer}"),
        ("Given the fact \"{fact}\", what is the answer to the question or completion \"{question_stem}\"\n\n{options_}", "{answer}"),
        ("Knowing that \"{fact}\", how would one answer \"{question_stem}\"\n\n{options_}", "{answer}"),
        ("Use evidence from the fact that {fact} to answer this question: \"{question_stem}\"\n\n{options_}", "{answer}"),
        ("Fact: {fact}\nQuestion: {question_stem}\n\nWhat's the answer?\n\n{options_}", "{answer}"),
        ("Use this fact to answer the question: {fact}\n\n{question_stem}\n\n{options_}", "{answer}"),
        ("What sentence would provide a factual answer to this question: \"{question_stem}\"", "{fact}"),
